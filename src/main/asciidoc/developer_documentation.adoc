...
|CrudRepository |org.springframework.data.repository |CampingticketRepository, DayticketRepository, Festival, Staff
|DataInitializer |org.salespointframework.core |Inventory, Staff
|Errors |org.springframework.validation |EconomicController, TicketController, Staff
|GetMapping |org.springframework.web.bind.annotation.GetMapping |EconomicController, TicketController
...
|PostMapping |org.springframework.web.bind.annotation.PostMapping |TicketController
...
|Valid |javax.validation.Valid |EconomicController, TicketController
|===
